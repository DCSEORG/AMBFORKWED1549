...
echo "=========================================="
echo "Expense Management System with GenAI Chat"
echo "=========================================="
echo ""
...
# Step 3: Configure App Service settings (including GenAI settings)
...
echo "  Chat UI URL: https://${APP_SERVICE_NAME}.azurewebsites.net/Chat"
echo "  (Note: Navigate to /Index or /Chat, not just the root URL)"
echo ""
